...
- Condenser base + registry: `openhands/memory/condenser/condenser.py`.
- Condenser implementations: `openhands/memory/condenser/impl/*`.
- View object injects summaries and drops forgotten event IDs:
  `openhands/memory/view.py`.
- Condensation actions: `openhands/events/action/agent.py`.
