...
Use this template as `docs/coding-agents/<submodule>/reference/project-snapshot.md`.
...
- Commits: `git -C src/coding-agents/<submodule> rev-list --count HEAD`
- Contributors: `git -C src/coding-agents/<submodule> shortlog -sne | wc -l`
- Default branch:
- License:
